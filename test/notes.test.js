...
describe.only('Noteful API - Notes', function () {
      ...
      return Promise.all([
        ...
        .then(([data, res]) => {
          ...
          res.body.forEach(function (item, i) {
            ...
            expect(item).to.include.keys('title', '__v', '_id', 'content', 'tags', 'createdAt', 'updatedAt', 'userId');
            console.log(item)
    ...
    it('should return correct search results for a searchTerm query', function () {
      ...
      return Promise.all([dbPromise, apiPromise])
        .then(([data, res]) => {
          ...
          res.body.forEach(function (item, i) {
            expect(item).to.be.a('object');
            expect(item).to.include.all.keys('title', '__v', '_id', 'content', 'tags', 'createdAt', 'updatedAt', 'userId'); //folderId and content are optional
            expect(item.id).to.equal(data.id);
            expect(item.title).to.equal(data[i].title);
            expect(item.content).to.equal(data[i].content);
            expect(new Date(item.createdAt)).to.eql(data[i].createdAt);
    ...
    it('should return correct search results for content search', function () {
      ...
      return Promise.all([dbPromise, apiPromise])
        .then(([data, res]) => {
          ...
          res.body.forEach(function (item, i) {
            expect(item).to.be.a('object');
            expect(item).to.include.all.keys('title', '__v', '_id', 'content', 'tags', 'createdAt', 'updatedAt', 'userId');
            expect(item.id).to.equal(data.id);
            expect(item.title).to.equal(data[i].title);
            expect(item.content).to.equal(data[i].content);
            expect(new Date(item.createdAt)).to.eql(data[i].createdAt);
    ...
    it('should return correct notes', function () {
      ...
      return Note.findOne({ userId: user.id })
        ...
        .then((res) => {
          ...
          expect(res.body).to.include.all.keys('title', '__v', '_id', 'content', 'tags', 'createdAt', 'updatedAt', 'userId');
  ...
  describe('POST /api/notes', function () {
    ...
    it.skip('should create and return a new item when provided valid data', function () {
      const newItem = {
      ...
      return chai.request(app)
        ...
        .then(function (_res) {
          ...
          expect(res).to.be.json;
          expect(res.body).to.be.a('object');
          expect(res.body).to.have.all.keys('title', '__v', '_id', 'content', 'tags', 'createdAt', 'updatedAt', 'userId');
    ...
    it('should create and return a new item when provided valid title (content optional)', function () {
      ...
      return chai.request(app)
        ...
        .then(function (_res) {
          ...
          expect(res).to.be.json;
          expect(res.body).to.be.a('object');
          expect(res.body).to.have.all.keys('title', '__v', '_id', 'tags', 'createdAt', 'updatedAt', 'userId');
    ...
    it('should create and return when folderId is an empty string', function () {
      ...
      return chai.request(app)
        ...
        .then(function (_res) {
          ...
          expect(res).to.be.json;
          expect(res.body).to.be.a('object');
          expect(res.body).to.include.keys('title', '__v', '_id', 'tags', 'createdAt', 'updatedAt', 'userId');
          return Note.findOne({ _id: res.body.id });
        })
        .then(data => {
        //   expect(res.body.id).to.equal(data.id);
  ...
  describe('PUT /api/notes/:id', function () {
    ...
    it('should update the note when provided a valid title', function () {
      ...
      return Note.findOne({ userId: user.id })
        ...
        .then(function (res) {
          ...
          expect(res).to.be.json;
          expect(res.body).to.be.a('object');
          expect(res.body).to.include.keys('title', '__v', '_id', 'content', 'tags', 'createdAt', 'updatedAt', 'userId');
        //   expect(res.body.id).to.equal(data.id);
    ...
    it.skip('should update the note when provided a valid tag', function () {
